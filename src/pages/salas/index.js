...
import { Button, Drawer, Icon, Modal, Tag, Uploader, TagPicker } from "rsuite";
...
const Salas = () => {
  ...
  const { servicos, salas, sala, behavior, form, components } = useSelector(
    (state) => state.sala
  );
        ...
        <div className="row h-100">
          ...
          <div className="col p-5 overflow-auto h100">
            ...
            >
              <Drawer.Body>
                <h3>
                  {behavior === "create" ? "Criar Novo" : "Atualizar"} Sala
                </h3>
                <div className="row mt-3">
                  ...
                  <div className="col-12">
                    <b className="">Serviços</b>
                    <TagPicker
                      size="lg"
                      block
                      data={servicos}
                      value={sala.especialidades}
                      onChange={(e) => setSala("especialidades", e)}
                    />
                  </div>
                  <div className="col-12">
                ...
                <Table
                  ...
                  config={[
                    ...
                    },
                    {
                      label: "Mesas da Sala",
                      key: "mesas",
                      content: (sala) => sala.mesas,
                      sortable: true,
                    },
                    {
                      label: "Lotação Máxima da Sala",
                      key: "lotacao_max",
                      content: (sala) => sala.lotacao_max,
                      sortable: true,
                    },
                    {
                      label: "Status",
